...
saveRDS(var.rank, "../../output/survival/rank_hete/fed_rank_hete.rds")
var.rank <- readRDS("../../output/survival/rank_hete/fed_rank_hete.rds")
...
ref <- find_reference("hete", names_all_site, dat1_split$all_train, var_final, uni_cut, modelIndex = "change_ref", heterogeneity = T)
