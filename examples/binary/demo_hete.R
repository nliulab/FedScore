...
names_all_site <- c("hete_S1", "hete_S2")
cutoff <- uni_cut
# 1. write site_beta.json independently at each site:
write_Lbeta("hete_S1", names_all_site, dat1_split$train, var.rank, cutoff) # site1
write_Lbeta("hete_S2", names_all_site, dat2_split$train, var.rank, cutoff) # site2
# 2. write site_intermediate.json:
write_Ds("hete_S1", "homo_S2", names_all_site, dat2_split$train, var.rank, cutoff)
write_Ds("hete_S2", "homo_S1", names_all_site, dat1_split$train, var.rank, cutoff)
# 3. do federated LR
dat1_train_transformed <- transform_df_fixed(dat1_split$train, uni_cut)
dat2_train_transformed <- transform_df_fixed(dat2_split$train, uni_cut)
